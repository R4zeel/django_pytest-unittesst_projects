...
class TestNoteCreation(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.note = Note.objects.create(title='Заголовок', text='Текст', author_id=cls.author.id)
...
class TestNoteEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.note = Note.objects.create(title='Заголовок', text=cls.NOTE_CONTENT, author_id=cls.author.id)
